...
export function InactivityWarningModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm animate-fade-in">
      <div className="w-full max-w-sm rounded-3xl bg-slate-50 border border-amber-500/40 p-6 shadow-[0_0_50px_rgba(245,158,11,0.2)] text-center space-y-4">
        ...
        <div className="flex flex-col gap-2 pt-2">
          ...
          <button
            onClick={onLogoutNow}
            className="w-full py-2 rounded-xl bg-slate-50 border border-slate-200 hover:bg-[#222] text-slate-500 hover:text-slate-900 font-semibold text-xs transition-all"
          >
            Log Out Now
          </button>
        </div>
