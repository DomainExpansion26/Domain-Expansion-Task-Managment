...
export async function GET(request: NextRequest) {
  try {
    ...
    const formatted = members.map((m) => ({
      ...
      isActive: m.isActive,
      accountStatus: m.accountStatus || (m.isActive ? "ACTIVE" : "INACTIVE"),
      joiningDate: m.joiningDate || m.hrProfile?.joiningDate || m.createdAt,
      ndaAccepted: m.ndaAccepted ?? false,
      ndaAcceptedAt: m.ndaAcceptedAt || null,
      ndaVersionAccepted: m.ndaVersionAccepted || null,
      manager: m.manager,
