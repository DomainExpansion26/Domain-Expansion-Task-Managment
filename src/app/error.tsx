      ...
      <div className="w-full max-w-md rounded-3xl border border-[#2E2E2E] bg-[#141414] p-8 text-center shadow-2xl">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <button
            ...
            className="flex w-full sm:w-auto items-center justify-center gap-2 rounded-xl border border-[#2E2E2E] bg-[#1A1A1A] px-5 py-2.5 text-xs font-semibold text-[#ACACB8] hover:bg-[#252525] hover:text-white transition-all cursor-pointer"
          >
